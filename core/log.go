...
func getLogWriter() zapcore.WriteSyncer {
	if _, err := os.Stat(getHomeDir() + "/fcm-upload/log"); err != nil {
		_ = os.MkdirAll(getHomeDir()+"/fcm-upload/log", 0755)
	}
	filePath := getHomeDir() + "/fcm-upload/log/" + time.Now().Format("2006-01-02") + ".log"
